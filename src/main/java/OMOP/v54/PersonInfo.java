...
public class PersonInfo implements DataTypeInfo {
    ...
    public boolean isJoinableCodePath(final String codePath) {
        return codePath.equals("ethnicitySourceConcept")
               || codePath.equals("raceSourceConcept")
               || codePath.equals("genderSourceConcept")
               || codePath.equals("ethnicityConcept")
               || codePath.equals("raceConcept")
