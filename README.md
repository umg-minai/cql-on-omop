...
Successful compilation produces a standalone application in a file like `target/cql-on-omop-1.1.8-SNAPSHOT.jar`.
...
```bash
CQL_ON_OMOP_DATABASE_PASSWORD=$(GET-PASSWORD) java -jar REPOSITORY-DIRECTORY/target/cql-on-omop-1.1.8-SNAPSHOT.jar \
